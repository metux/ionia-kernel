...
#define duagon_i10x_mii         6
#define duagon_i10x_rmii        7
...
static void setup_duagon_i101(void)
{
	...
	am33xx_evmid_fillup(duagon_i10x_rmii);
}

static void am335x_setup_daughter_board(struct nvmem_device *m, void *c)
{
	int ret;
	...
	ret = nvmem_device_read(m, 0, sizeof(config1), (char *)&config1);
...
static void am335x_evm_setup(struct nvmem_device *mem_acc, void *context)
{
	char tmp[10];
